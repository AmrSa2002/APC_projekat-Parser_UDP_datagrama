...
Kako je prikazano, definisani su takt signal '**clk**', te reset signal _rst_. Kako je naglašeno, _in_data_ signal predstavlja podatke koje se prenose, odnosno pakete iz okvira definisanih u _Uvodu_. U nastavku je dat opis paketa:
...
Izlazni podaci _out_data_ se pojavljuju nakon obrade ulaznog toka, a _channel_ pokazuje vrijednosti OD što sugeriše da parser signalizira završetak prenosa podataka i selekciju odgovarajućeg izlaznog kanala.
